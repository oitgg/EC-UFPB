          ...
          <div className="five columns">
            ...
            <div className="Profile__stats">
              ...
              <div
                ...
                <span className="Profile__stats-count">{user.followersCount}</span> {pluralize(user.followersCount, 'follower', 'seguidores')}
              </div>
              <div
                className="Profile__stats-item Profile__stats-item--link"
                onClick={() => this._openUsersModal('following')}>
                <span className="Profile__stats-count">{user.followingCount}</span> {pluralize(user.followingCount, 'following', 'seguindo')}
              </div>
            </div>
          </div>
        </div>
