    ...
    ui(new Ui::MainWindow)
{
    ...
    askCanvas.setWindowTitle(QString("Tamanho do Canvas"));
    askCanvas.exec();
    cancel = false;
...
{
    QString filename = QFileDialog::getSaveFileName( this,"Salvar Arquivo","","Canvas (*.canv)");
...
{
    QString filename = QFileDialog::getOpenFileName(this,"Abrir Arquivo","","Canvas (*.canv)" );
    if(filename == NULL) return;
    QFile f(filename);
